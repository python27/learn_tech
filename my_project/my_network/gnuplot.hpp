...
/// 4. separated compiling
///    by Yu-Xin Su (12/28/11)
/// Requirements:
...
class Gnuplot
{
   ...
   Gnuplot& savetopng(const std::string &filename = "gnuplot_ourput");
    //----------------------------------------------------------------------------------
    // set and unset
    ...
    /// \return <-- reference to the gnuplot object
    // --------------------------------------------------------------------------
    inline Gnuplot& set_hidden3d(){cmd("set hidden3d");return *this;};
