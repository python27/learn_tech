 ...
 ******************************************************************/
   UGraph::pGraph GenKNearestNetwork(size_t numberOfNodes, size_t k);
 ...
 *****************************************************************/
   UGraph::pGraph GenSmallWorldNetworkByWS(size_t numberOfNodes, size_t k,
					   double probability);
 ...
 *****************************************************************/
   UGraph::pGraph GenSmallWorldNetworkByNW(size_t numberOfNodes, size_t k,
					    double probability);
 ...
 *****************************************************************/
   UGraph::pGraph GenRandomNetwork(size_t numberOfNodes, double probability);
 ...
 * @return UGraph::pGraph
 *****************************************************************/
   UGraph::pGraph GenScaleFreeNetwork(size_t numberOfNodes, size_t degree);
 ...
 *****************************************************************/
   UGraph::pGraph GenSmallWorldByEdgeIteration(size_t times);
 ...
 *****************************************************************/
   UGraph::pGraph GenUniformRecursiveTree(size_t numberOfNodes);
 ...
 *****************************************************************/
   UGraph::pGraph GenDURT(size_t times);
 ...
 * deterministic uniform recursive tree
 *****************************************************************/
   UGraph::pGraph GenSmallWorldNetworkFromDURT(size_t times);
  ...
  * @return UGraph::pGraph
  ************************************************************************/
   UGraph::pGraph GenCommunityNetwork(size_t numberOfNodes, size_t numberOfCommunity,
					double inner_prob, double outer_prob);

 /************************************************************************
  * @name GenTriangleExtendedDSWN - Generates a deterministic
  * small-world network by simply extending a triangle.
  * @param iteration_times -  times for iteration
  * @return UGraph::pGraph
  * @ref ....
  ************************************************************************/
   UGraph::pGraph GenTriangleExtendedDSWN(size_t iteration_times);
  ...
  * @return UGraph::pGraph
  ************************************************************************/
   UGraph::pGraph GenTreeStructuredSW(size_t times); 
  ...
  * @return UGraph::pGraph
 *************************************************************************/
   UGraph::pGraph GenTreeStructuredSFSW(size_t numberOfNodes);
  ...
  ************************************************************************/
   UGraph::pGraph  GenSwirlShapedNetwork(size_t times);
  ...
  * small-world network
  ******************************************************************************/
   UGraph::pGraph  GenPinWheelShapedSW(size_t times);
 ...
 * degree distribution
 ********************************************************************************/
   //pUGraphList  GenNetworkFromDegreeDistribution(Map<size_t> &degree_list);
 ...
 */
   //UGraph::pGraph  RenormalizeByBoxCounting(UGraph::pGraph graph, size_t length);
};
